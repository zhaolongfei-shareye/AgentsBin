(function () {
  const base = {
    ...
    hero_cta: "Download AgentsBin 1.1.0",
    ...
    dl_name: "AgentsBin 1.1.0 · Free Beta",
  ...
  const jaOverrides = {
    ...
    hero_cta: "AgentsBin 1.1.0 をダウンロード",
  ...
  const esOverrides = {
    ...
    hero_cta: "Descargar AgentsBin 1.1.0",
    ...
    dl_name: "AgentsBin 1.1.0 · Beta gratis",
    dl_meta: "macOS 13+ · ~511 KB",
  ...
  const frOverrides = {
    ...
    hero_cta: "Télécharger AgentsBin 1.1.0",
    ...
    dl_name: "AgentsBin 1.1.0 · Bêta gratuite",
  ...
  const deOverrides = {
    ...
    hero_cta: "AgentsBin 1.1.0 herunterladen",
    ...
    dl_name: "AgentsBin 1.1.0 · Kostenlose Beta",
  ...
  const ruOverrides = {
    ...
    hero_cta: "Скачать AgentsBin 1.1.0",
    ...
    dl_name: "AgentsBin 1.1.0 · Бесплатная бета",
  ...
  const ptOverrides = {
    ...
    hero_cta: "Baixar AgentsBin 1.1.0",
    ...
    dl_name: "AgentsBin 1.1.0 · Beta grátis",
    dl_meta: "macOS 13+ · ~511 KB",
    dl_btn: "Baixar DMG",
