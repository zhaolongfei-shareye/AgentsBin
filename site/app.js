(function () {
  const base = {
    ...
    hero_cta: "Download AgentsBin 1.0.22",
    ...
    d2d: "Official favicon icons, drag-to-reorder agent list, custom agents, import and export.",
    d3t: "10 languages",
    ...
    d6t: "Floating agent panel",
    d6d: "The agent list floats over the window, expands on hover and stays out of the way.",
    ...
    dl_name: "AgentsBin 1.0.22 · Free Beta",
  ...
  const zhOverrides = {
    ...
    d5d: "一次专注一个智能体，保留登录态。",
    d6t: "浮层智能体面板",
    d6d: "智能体列表以浮层显示，鼠标移入自动展开，不占用内容空间。",
    howto_title: "操作说明",
    h1t: "安装并启动",
    ...
    dl_name: "AgentsBin 1.0.22 · 免费内测版",
  ...
  const zhHantOverrides = {
    ...
    d6t: "浮層智能體面板",
    d6d: "智能體列表以浮層顯示，滑鼠移入自動展開，不佔用內容空間。",
    howto_title: "操作說明",
    h1t: "安裝並啟動",
    ...
    dl_name: "AgentsBin 1.0.22 · 免費內測版",
  ...
  const jaOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.22 をダウンロード",
    ...
    d2t: "エージェント管理",
    d2d: "公式ファビコン、ドラッグ並べ替え、カスタムエージェント、インポート/エクスポート。",
    d3t: "10 言語",
    ...
    d6t: "フローティングパネル",
    d6d: "エージェント一覧はフローティング表示。ホバーで自動展開し、コンテンツを邪魔しません。",
    howto_title: "使い方",
    h1t: "インストールと起動",
    ...
    dl_name: "AgentsBin 1.0.22 · 無料ベータ",
  ...
  const koOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.22 다운로드",
    ...
    d2t: "에이전트 관리",
    d2d: "공식 파비콘, 드래그 정렬, 커스텀 에이전트, 가져오기/내보내기.",
    d3t: "10개 언어",
    ...
    d6t: "플로팅 에이전트 패널",
    d6d: "에이전트 목록이 플로팅으로 표시되고, 마우스를 올리면 자동으로 펼쳐집니다.",
    howto_title: "사용 방법",
    h1t: "설치 및 실행",
    ...
    dl_name: "AgentsBin 1.0.22 · 무료 베타",
  ...
  const esOverrides = {
    ...
    hero_cta: "Descargar AgentsBin 1.0.22",
    ...
    d2d: "Iconos oficiales, ordena arrastrando, agentes personalizados e importar/exportar.",
    d3t: "10 idiomas",
    ...
    d6t: "Panel flotante",
    d6d: "La lista de agentes flota sobre la ventana y se despliega al pasar el ratón.",
    ...
    dl_name: "AgentsBin 1.0.22 · Beta gratis",
    dl_meta: "macOS 13+ · ~511 KB",
  ...
  const frOverrides = {
    ...
    hero_cta: "Télécharger AgentsBin 1.0.22",
    ...
    d2d: "Icônes officielles, tri par glisser, agents personnalisés, import/export.",
    d3t: "10 langues",
    ...
    d6t: "Panneau flottant",
    d6d: "La liste des agents flotte sur la fenêtre et s'ouvre au survol.",
    ...
    dl_name: "AgentsBin 1.0.22 · Bêta gratuite",
  ...
  const deOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.22 herunterladen",
    ...
    d2d: "Offizielle Icons, Ziehen zum Sortieren, eigene Agenten, Import/Export.",
    d3t: "10 Sprachen",
    ...
    d6t: "Schwebendes Panel",
    d6d: "Die Agentenliste schwebt über dem Fenster und öffnet sich bei Hover.",
    ...
    dl_name: "AgentsBin 1.0.22 · Kostenlose Beta",
  ...
  const ruOverrides = {
    ...
    hero_cta: "Скачать AgentsBin 1.0.22",
    ...
    d2d: "Официальные иконки, перетаскивание, свои агенты, импорт/экспорт.",
    d3t: "10 языков",
    ...
    d6t: "Плавающая панель",
    d6d: "Список агентов плавает над окном и раскрывается при наведении.",
    ...
    dl_name: "AgentsBin 1.0.22 · Бесплатная бета",
  ...
  const ptOverrides = {
    ...
    hero_cta: "Baixar AgentsBin 1.0.22",
    ...
    d2d: "Ícones oficiais, arrastar para ordenar, agentes personalizados, importar/exportar.",
    d3t: "10 idiomas",
    ...
    d6t: "Painel flutuante",
    d6d: "A lista de agentes flutua sobre a janela e abre ao passar o mouse.",
    ...
    dl_name: "AgentsBin 1.0.22 · Beta grátis",
    dl_meta: "macOS 13+ · ~511 KB",
    dl_btn: "Baixar DMG",
