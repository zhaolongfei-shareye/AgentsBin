(function () {
  const base = {
    ...
    hero_cta: "Download AgentsBin 1.0.18",
    ...
    dl_name: "AgentsBin 1.0.18 · Free Beta",
  ...
  const zhOverrides = {
    ...
    dl_name: "AgentsBin 1.0.18 · 免费内测版",
  ...
  const zhHantOverrides = {
    ...
    dl_name: "AgentsBin 1.0.18 · 免費內測版",
  ...
  const jaOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.18 をダウンロード",
    ...
    dl_name: "AgentsBin 1.0.18 · 無料ベータ",
  ...
  const koOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.18 다운로드",
    ...
    dl_name: "AgentsBin 1.0.18 · 무료 베타",
  ...
  const esOverrides = {
    ...
    hero_cta: "Descargar AgentsBin 1.0.18",
    ...
    dl_name: "AgentsBin 1.0.18 · Beta gratis",
    dl_meta: "macOS 13+ · ~511 KB",
  ...
  const frOverrides = {
    ...
    hero_cta: "Télécharger AgentsBin 1.0.18",
    ...
    dl_name: "AgentsBin 1.0.18 · Bêta gratuite",
  ...
  const deOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.18 herunterladen",
    ...
    dl_name: "AgentsBin 1.0.18 · Kostenlose Beta",
  ...
  const ruOverrides = {
    ...
    hero_cta: "Скачать AgentsBin 1.0.18",
    ...
    dl_name: "AgentsBin 1.0.18 · Бесплатная бета",
  ...
  const ptOverrides = {
    ...
    hero_cta: "Baixar AgentsBin 1.0.18",
    ...
    dl_name: "AgentsBin 1.0.18 · Beta grátis",
    dl_meta: "macOS 13+ · ~511 KB",
    dl_btn: "Baixar DMG",
