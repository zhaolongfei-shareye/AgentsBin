(function () {
  const base = {
    ...
    hero_cta: "Download AgentsBin 1.0.20",
    ...
    dl_name: "AgentsBin 1.0.20 · Free Beta",
  ...
  const zhOverrides = {
    ...
    dl_name: "AgentsBin 1.0.20 · 免费内测版",
  ...
  const zhHantOverrides = {
    ...
    dl_name: "AgentsBin 1.0.20 · 免費內測版",
  ...
  const jaOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.20 をダウンロード",
    ...
    dl_name: "AgentsBin 1.0.20 · 無料ベータ",
  ...
  const koOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.20 다운로드",
    ...
    dl_name: "AgentsBin 1.0.20 · 무료 베타",
  ...
  const esOverrides = {
    ...
    hero_cta: "Descargar AgentsBin 1.0.20",
    ...
    dl_name: "AgentsBin 1.0.20 · Beta gratis",
    dl_meta: "macOS 13+ · ~511 KB",
  ...
  const frOverrides = {
    ...
    hero_cta: "Télécharger AgentsBin 1.0.20",
    ...
    dl_name: "AgentsBin 1.0.20 · Bêta gratuite",
  ...
  const deOverrides = {
    ...
    hero_cta: "AgentsBin 1.0.20 herunterladen",
    ...
    dl_name: "AgentsBin 1.0.20 · Kostenlose Beta",
  ...
  const ruOverrides = {
    ...
    hero_cta: "Скачать AgentsBin 1.0.20",
    ...
    dl_name: "AgentsBin 1.0.20 · Бесплатная бета",
  ...
  const ptOverrides = {
    ...
    hero_cta: "Baixar AgentsBin 1.0.20",
    ...
    dl_name: "AgentsBin 1.0.20 · Beta grátis",
    dl_meta: "macOS 13+ · ~511 KB",
    dl_btn: "Baixar DMG",
