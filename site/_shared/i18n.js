(function () {
  ...
  var E = {
    en: {
      ...
      sh_tagline: 'One local-first dashboard for your one-person company.',
      tag_web: 'Web App', tag_open: 'Open source', sh_btn: 'Try Demo',
    ...
    zh: {
      ...
      sh_tagline: '一人公司，一个本地优先仪表盘。',
      tag_web: 'Web 应用', tag_open: '开源', sh_btn: '在线体验',
    ...
    "zh-Hant": {
      ...
      sh_tagline: '一人公司，一個本地優先儀表板。',
      tag_web: 'Web 應用', tag_open: '開源', sh_btn: '線上體驗',
    ...
    ja: {
      ...
      sh_tagline: '一人会社のためのローカル優先ダッシュボード。',
      tag_web: 'Webアプリ', tag_open: 'オープンソース', sh_btn: 'デモを試す',
    ...
    ko: {
      ...
      sh_tagline: '1인 기업을 위한 로컬 우선 대시보드.',
      tag_web: '웹 앱', tag_open: '오픈소스', sh_btn: '데모 체험',
    ...
    es: {
      ...
      sh_tagline: 'Un panel local-first para tu empresa de una persona.',
      tag_web: 'App web', tag_open: 'Código abierto', sh_btn: 'Probar demo',
    ...
    fr: {
      ...
      sh_tagline: 'Un tableau de bord local-first pour votre entreprise individuelle.',
      tag_web: 'App web', tag_open: 'Open source', sh_btn: 'Essayer la démo',
    ...
    de: {
      ...
      sh_tagline: 'Ein lokales Dashboard für dein Ein-Personen-Unternehmen.',
      tag_web: 'Web-App', tag_open: 'Open Source', sh_btn: 'Demo testen',
    ...
    ru: {
      ...
      sh_tagline: 'Локальная панель для вашей компании из одного человека.',
      tag_web: 'Веб-приложение', tag_open: 'Открытый код', sh_btn: 'Открыть демо',
    ...
    pt: {
      ...
      sh_tagline: 'Um painel local-first para sua empresa de uma pessoa.',
      tag_web: 'App web', tag_open: 'Código aberto', sh_btn: 'Testar demo',
