(function () {
  ...
  var E = {
    ...
    ru: {
      home_hero_title: 'Инструменты ИИ для macOS,<br><span class="grad">маленькие и точные</span>.',
      home_hero_lead: 'Четыре инструмента. Одна локальная студия. Каждое приложение работает локально и чисто.',
      cta_explore: 'Смотреть продукты', cta_wf: 'Watermark Factory', cta_solohq: 'SoloHQ',
      section_released: 'Выпущено', section_released_sub: 'Доступно сейчас, бесплатно.',
      section_dev: 'В разработке', section_dev_sub: 'Следующее из той же студии.',
      ab_tagline: 'Все ИИ-агенты в одном клике от меню.',
      wf_tagline: 'Восстанавливайте чистые изображения, 100% локально.',
      qs_tagline: 'Думайте стратегиями, проверяйте данными.',
      tts_tagline: 'Превращайте текст в естественный голос.',
      tag_menu: 'Меню', tag_43: '43 агента', tag_api: 'API-режим',
      tag_offline: 'Офлайн', tag_sources: '30+ источников', tag_batch: 'Пакет',
      tag_backtest: 'Бэктест', tag_copilot: 'ИИ-помощник', tag_local: 'Локально',
      tag_multi: 'Многоязычный', tag_voice: 'Прослушивание', tag_episode: 'Экспорт эпизода',
      btn_download: 'Скачать',
      nav_home: 'Главная',
      home_trust: 'Бесплатно · macOS 13+ · Без аккаунта',
      home_live_badge: 'LIVE · ЛОКАЛЬНЫЙ ИИ',
      home_chip_sources: '30+ источников',
      home_chip_local: '100% локально',
      in_dev: 'В разработке',
      home_footer: '© 2026 AgentsBin · Студия AI-инструментов для macOS'
    },
    pt: {
      home_hero_title: 'Ferramentas de IA para macOS,<br><span class="grad">pequenas e afiadas</span>.',
      home_hero_lead: 'Quatro ferramentas. Um estúdio local-first. Cada app roda local e limpo.',
      cta_explore: 'Explorar produtos', cta_wf: 'Watermark Factory', cta_solohq: 'SoloHQ',
      section_released: 'Lançados', section_released_sub: 'Disponível agora, grátis.',
      section_dev: 'Em desenvolvimento', section_dev_sub: 'O próximo do mesmo estúdio.',
      ab_tagline: 'Todos os seus agentes de IA a um clique.',
      wf_tagline: 'Restaura imagens limpas, 100% local.',
      qs_tagline: 'Pense em estratégias, teste com dados.',
      tts_tagline: 'Transforme roteiros em voz natural.',
      tag_menu: 'Menu', tag_43: '43 agentes', tag_api: 'Modo API',
      tag_offline: 'Offline', tag_sources: '30+ fontes', tag_batch: 'Lote',
      tag_backtest: 'Backtest', tag_copilot: 'Copiloto de IA', tag_local: 'Local primeiro',
      tag_multi: 'Multilíngue', tag_voice: 'Pré-visualização', tag_episode: 'Exportar episódio',
      btn_download: 'Baixar',
      nav_home: 'Início',
      home_trust: 'Grátis · macOS 13+ · Sem conta',
      home_live_badge: 'AO VIVO · IA LOCAL',
      home_chip_sources: '30+ fontes',
      home_chip_local: '100% local',
      in_dev: 'Em desenvolvimento',
      home_footer: '© 2026 AgentsBin · Estúdio de ferramentas de IA para macOS'
    }
  };
