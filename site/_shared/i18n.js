(function () {
  var L = {
    en: {
      ...
      cat_all: "All", cat_assistants: "AI Assistants", cat_audio: "Audio", cat_media: "Media Tools",
    ...
    zh: {
      ...
      cat_all: "全部", cat_assistants: "AI 助手", cat_audio: "音频", cat_media: "媒体工具",
    ...
    "zh-Hant": {
      ...
      cat_all: "全部", cat_assistants: "AI 助手", cat_audio: "音頻", cat_media: "媒體工具",
    ...
    ja: {
      ...
      cat_all: "すべて", cat_assistants: "AIアシスタント", cat_audio: "オーディオ", cat_media: "メディア",
    ...
    ko: {
      ...
      cat_all: "전체", cat_assistants: "AI 어시스턴트", cat_audio: "오디오", cat_media: "미디어 도구",
    ...
    es: {
      ...
      cat_all: "Todos", cat_assistants: "Asistentes IA", cat_audio: "Audio", cat_media: "Herramientas multimedia",
    ...
    fr: {
      ...
      cat_all: "Tous", cat_assistants: "Assistants IA", cat_audio: "Audio", cat_media: "Outils média",
    ...
    de: {
      ...
      cat_all: "Alle", cat_assistants: "KI-Assistenten", cat_audio: "Audio", cat_media: "Medien-Tools",
  ...
  var E = {
    en: {
      ...
      cta_explore: 'Explore products', cta_wf: 'Watermark Factory',
    ...
    ja: {
      ...
      cta_explore: '製品を見る', cta_wf: 'Watermark Factory',
    ...
    ko: {
      ...
      cta_explore: '제품 살펴보기', cta_wf: 'Watermark Factory',
    ...
    es: {
      ...
      cta_explore: 'Explorar productos', cta_wf: 'Watermark Factory',
    ...
    fr: {
      ...
      cta_explore: 'Explorer les produits', cta_wf: 'Watermark Factory',
    ...
    de: {
      ...
      cta_explore: 'Produkte entdecken', cta_wf: 'Watermark Factory',
