...
const STRINGS = {
  en: {
    ...
    f6t: "JSON backup",
    f6d: "Export and import everything as JSON. Your data always belongs to you.",
  ...
  ja: {
    ...
    f6t: "JSONバックアップ",
    f6d: "すべてをJSONでエクスポート・インポート。データは常にあなたのもの。",
    demo_title: "ライブデモを試す",
  ...
  ko: {
    ...
    f6t: "JSON 백업",
    f6d: "모든 데이터를 JSON으로 내보내고 가져옵니다. 데이터는 언제나 당신의 것.",
  ...
  es: {
    ...
    f6t: "Copia JSON",
    f6d: "Exporta e importa todo como JSON. Tus datos siempre son tuyos.",
  ...
  fr: {
    ...
    f6t: "Sauvegarde JSON",
    f6d: "Exportez et importez tout en JSON. Vos données vous appartiennent toujours.",
  ...
  de: {
    ...
    f6t: "JSON-Backup",
    f6d: "Exportiere und importiere alles als JSON. Deine Daten gehören dir.",
  ...
  ru: {
    ...
    f6t: "JSON-резервная копия",
    f6d: "Экспортируйте и импортируйте всё как JSON. Данные всегда принадлежат вам.",
  ...
  pt: {
    ...
    f6t: "Backup JSON",
    f6d: "Exporte e importe tudo como JSON. Seus dados sempre pertencem a você.",
